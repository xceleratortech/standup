...
export function AddParticipantDialog({
  ...
  const [selectedRole, setSelectedRole] = useState<string>(MEETING_ROLES.VIEWER);
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>Add a workspace member to this meeting</DialogDescription>
        </DialogHeader>
                  ...
                  {availableMembers.map((member) => (
                    <div
                      ...
                      className={`flex cursor-pointer items-center gap-3 rounded-md p-2 transition-colors ${
                        selectedUserId === member.userId ? 'bg-secondary' : 'hover:bg-muted'
                      }`}
                    ...
                    >
                      ...
                      <div className="flex-1 overflow-hidden">
                        <p className="truncate font-medium">{member.name || 'Unnamed User'}</p>
          ...
          <div className="space-y-2">
            ...
            <Select value={selectedRole} onValueChange={setSelectedRole} disabled={isSubmitting}>
              ...
              <SelectContent>
                ...
                <SelectItem value={MEETING_ROLES.COMMENTER}>Commenter</SelectItem>
                <SelectItem value={MEETING_ROLES.EDITOR}>Editor</SelectItem>
                <SelectItem value={MEETING_ROLES.ORGANIZER}>Organizer</SelectItem>
              </SelectContent>
            </Select>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleAddParticipant} disabled={!selectedUserId || isSubmitting}>
            {isSubmitting ? (
              <>
